...
static void init(void) {
  ...
  //Setup Battery Layer
  batt_layer = text_layer_create(GRect(100, 38, 30, 20));
  text_layer_set_font(batt_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18_BOLD));
...
static void deinit(void) {
  ...
  layer_remove_from_parent(text_layer_get_layer(batt_layer));
